...
function create_user {
    ...
    create_user_message=$(mysql $CONNECTION_STRING -Bse  "CREATE USER '$MYSQL_NEW_USER'@'$MYSQL_NEW_USER_HOST' IDENTIFIED WITH mysql_native_password BY '$MYSQL_NEW_USER_PASSWORD';" 2>&1)
