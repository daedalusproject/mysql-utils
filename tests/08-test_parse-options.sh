...
EOF
    ...
    start_script grant --grant-priv-type="'NONSENSE'" --grant-other-account-characteristics="'WITH\ GRANT\ OPTION'" --grant-user="otheruser" --grant-database="otherdatabase" --grant-host="localhost" -uroot -pletmein -P3306 --host="percona-server" 2> $TMP_FOLDER/erroredgrant_test
    grant_error=$?
